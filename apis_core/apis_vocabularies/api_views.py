...
from .models import (CollectionType, EventEventRelation, EventType,
                     ...
                     InstitutionType, InstitutionWorkRelation,
...
from .serializers import (CollectionTypeSerializer,
                          EventEventRelationSerializer, EventTypeSerializer,
                          ...
                          PlacePlaceRelationSerializer, PlaceTypeSerializer,
                          PlaceWorkRelationSerializer,
                          ProfessionTypeSerializer, TextTypeSerializer,
                          UserAccSerializer, VocabNamesSerializer,
                          VocabsBaseClassSerializer, WorkTypeSerializer,
